    ...
    <body>
        <div id="wrapper">
          ...
          <div id="main">
            ...
            <div id="blue" style={{"background-color": "blue"}}>This is a blue block.</div>
            {/* <div id="black" style={{"background-color": "black"}}>This is a black block.fgyujnbvfgyujnbvfghjmn vghjnb vghjn</div>
            <div id="teal" style={{"background-color": "teal"}}>This is a teal blockgfyujnbvghjnbvcfghjnbcfghjnbv</div> */}
          </div>
          ...
          <div id="display">
            <h3>display</h3>
            <p>Defines a grid container and establishes a new grid dormatting context.</p>
          </div>
          <div id="grid">
            <h4>grid</h4>
